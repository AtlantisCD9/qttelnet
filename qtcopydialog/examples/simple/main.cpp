...
public:
    FileDialog(QWidget *parent = 0) : QDialog(parent) {
        ...
        createdDir  = QString::fromAscii("created");
        copiedDir   = QString::fromAscii("copied");
        movedDir    = QString::fromAscii("moved");
        copiedFiles = QString::fromAscii("copiedFiles");
        movedFiles  = QString::fromAscii("movedFiles");
